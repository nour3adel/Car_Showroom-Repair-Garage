	...
	do {
		...
		if (choice == 1) {
			...
			while (exit == 0)
			{
				...
				cout << "\n\t° -> Your Choise is:-> ";
				cin >> cschoice;
				while (cschoice != 0 && cschoice != 1 && cschoice != 2 ) {
					cout << "\t\tInvalid ";
					cout << "\n\t° -> Your Choise is:-> ";
					cin >> cschoice; cout << endl;
				...
				do {
					...
					for (int i = 0; i < Vshowroom.size(); i++) {
						if (ch == Vshowroom[i].id) {
							...
							cout << "\n";
							cout << "---------------------------------------------------------------------------------------------------" << endl;
							cout << "      CarID      " << "     Make  " << "          Model  " << "         Year     " << "       Price     " << "       Installment     " << "\t  " << "\t  " << endl;
							cout << "---------------------------------------------------------------------------------------------------" << endl;
							...
							for (int j = 0; j < Vshowroom[loc].cars.size(); j++) {
								...
								if (idcar == Vshowroom[loc].cars[j].id)
								{
								    ...
								    B.model= Vshowroom[loc].cars[buypos].model;
									B.Processid = k;
